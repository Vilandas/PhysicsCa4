...
namespace GDLibrary.Utilities
{
    public class MathUtility
    {
        ...
        public static Vector3 RotateVec(Vector3 toRotate, Vector3 rotationInRadians)
        {
            Matrix rotMatrix = Matrix.CreateFromYawPitchRoll(
                rotationInRadians.X, //Pitch
                rotationInRadians.Y, //Yaw
                rotationInRadians.Z); //Roll
            return Vector3.Transform(toRotate, rotMatrix);
        }
    }
}